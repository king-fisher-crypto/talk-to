                       ...
                       <?php
                            ...
                            $conf = array(
								'country_id'   => array(
									...
									'required' => true,
									'selected' => $vat['InvoiceVat']['country_id']
								),
								'society_type_id'   => array(
									'label' => array('text' => __('Société'), 'class' => 'col-sm-12 col-md-4 control-label required'),
									'options' => $select_societies,
									'required' => true,
									'selected' => $vat['InvoiceVat']['society_type_id']
								),
								
								'rate'             => array('label' => array('text' => __('Taux TVA'), 'class' => 'control-label required'), 'required' => true, 'value' =>$vat['InvoiceVat']['rate']),
								'description'             => array('label' => array('text' => __('Text facture'), 'class' => 'control-label'), 'required' => false, 'value' =>$vat['InvoiceVat']['description']),
								'show_vat_num'   => array(
