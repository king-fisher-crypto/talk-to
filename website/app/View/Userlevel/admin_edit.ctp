<?php
    ...
    echo $this->Metronic->breadCrumb(array(
        ...
        1 => array(
            ...
            'link' => $this->Html->url(array('controller' => 'userlevel', 'action' => 'edit', 'admin' => true))
        )
    ));
...
<div class="row-fluid">
    <div class="portlet box blue">
        <div class="portlet-title">
            <div class="caption">
                <?php echo __('Modification d\'un level à un compte admin'); ?>
            </div>
        </div>
                   ...
                   <div class="control-group">
                   	...
                   	<div class="controls">
                   		<select name="data[Userlevel][user_id]" class="span8" required="required" id="UserlevelUserId">
                   			<option selected value="<?php echo $level['Userlevel']['user_id']; ?>"><?php echo $level['User']['firstname']; ?></option>
                   		</select>
                   	</div>
                  </div>
                  <div class="control-group">
                   	...
                   	<div class="controls">
                   		<select name="data[Userlevel][level]" class="span8" required="required" id="UserlevelLevel">
							...
							foreach($levels as $lev){
								$selected = '';
								if($level['Userlevel']['level'] == $lev)$selected = ' selected ';
