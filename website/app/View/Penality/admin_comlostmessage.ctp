...
<div class="row-fluid">
    ...
    <div class="portlet box yellow">
        <div class="portlet-title">
            <div class="caption"><?php echo __('Emails perdu'); ?></div>
        </div>
        <div class="portlet-body">
            ...
            <?php else: ?>
                <table class="table table-striped table-hover table-bordered">
                    <thead>
                    <tr>
                        <th><?php echo $this->Paginator->sort('Message.date_add', __('Date')); ?></th>
                        <th><?php echo $this->Paginator->sort('Agent.pseudo', __('Agent')); ?></th>
                        <th><?php echo $this->Paginator->sort('User.firstname', __('Client')); ?></th>
						<th>Temps attente</th>
                        <th><?php echo $this->Paginator->sort('Message.etat', __('Vu par agent')); ?></th>
                    ...
                    <?php foreach ($allComs as $k => $row): ?>
                        <tr>
                           <td><?php echo $this->Time->format(Tools::dateZoneUser($this->Session->read('Config.timezone_user'),$row['Message']['date_add']),'%d %B %Y %H:%M'); ?></td>
