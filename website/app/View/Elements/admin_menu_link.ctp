<div class="row-fluid">
    <div class="span9">
        <div class="tabbable tabbable-custom tabbable-full-width">
            ...
            <div class="tab-content">
                <?php $i=0; foreach($langs as $id => $val): ?>
                    <div id="tab<?php echo $id; ?>" lang="<?php echo $id; ?>" class="tab-pane<?php echo ($i==0 ?' active':''); ?>">
                        <?php
                            if($idLink == 0)
    ...
    <div class="span3 link_edit panel-contenu">
        <?php echo $this->Metronic->inputCheckbox('MenuLink', 'Target', __('Nouvel onglet'), 'target', ($idLink == 0 ?0:1)); ?>
    </div>
</div>
<div class="row-fluid">
    <?php
