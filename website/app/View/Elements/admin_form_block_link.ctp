<div class="row-fluid">
                        ...
                        <?php
                            if($idLink == 0)
                                echo $this->Form->inputs(array(
                                    'MenuBlockLang.'.$id.'.lang_id'  => array('type' => 'hidden', 'value' => $id),
                                    'MenuBlockLang.'.$id.'.title'    => array('label' => array('text' => __('Titre'), 'class' => 'control-label required'), 'class' => 'input-xlarge')
                                ));
                            else
                                echo $this->Form->inputs(array(
                                    'MenuBlockLang.'.$id.'.lang_id'  => array('type' => 'hidden', 'value' => $id),
                                    'MenuBlockLang.'.$id.'.title'    => array(
    ...
    <?php
        if($idLink != 0)
            echo $this->Form->input('MenuBlockLang.menu_block_id', array('type' => 'hidden', 'value' => $idLink));
    ?>
</div>
<div class="row-fluid">
    <?php
        if($idLink == 0)
            echo $this->Metronic->getLinkButton(
                __('Créer'),
                array('controller' => 'menus', 'action' => 'create_block_link', 'admin' => true),
            ...
            echo $this->Metronic->getLinkButton(
                __('Enregistrer'),
                array('controller' => 'menus', 'action' => 'edit_block_link', 'admin' => true),
