...
<section class="masterclass-page page jswidth">


    <article>
	<h1 class="">  <?= __('Mes achats MasterClass') ?></h1>
	<?= __("Vos achats de MasterClass sont répertoriés sur la page ci-dessous, en cliquant sur le bouton \" Voir \" vous accédez aux détails, heures et dates de votre MasterClass et un bouton vous permet le jour J de vous connecter à celle-ci.") ?>
	...
	$montants = ["15,25$","20,00$","15,25$","15,25$","15,25$","20,00$","15,25$","Refusé","20,00$","20,00$","20,00$","15,25$","15,25$"];
	...
	<?php else : ?>
    	<div  class="overflow jswidth">
			...
			<th class="agent"><?php echo __('Agent'); ?></th> 
    			<th class="duree">Masterclass</th> 
    			<th class="statu"><?php echo __('Montant'); ?></th> 
