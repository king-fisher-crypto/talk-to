            ...
            <?php else: ?>
                <table class="table table-striped table-hover table-bordered">
                    ...
                    <?php foreach ($allComs as $k => $row): ?>
                        <tr>
                           <td><?php echo $this->Time->format(Tools::dateUser($this->Session->read('Config.timezone_user'),$row['Chat']['date_start']),'%d %B %Y %H:%M'); ?></td>
                           ...
                           <td>
							...
							<td>
                       			<?php
									if($row['Chat']['status'])echo 'Oui'; else echo 'Non';	
                       			?>	
                       			</td>
							
                       			<td><?php
									if($row['Chat']['date_send']){
									echo $this->Time->format(Tools::dateUser($this->Session->read('Config.timezone_user'),$row['Chat']['date_send']),'%d %B %Y %H:%M');
									}
									?></td>
                       			<td><?php
										if(!$row['Chat']['date_send']){
