    ...
    <div class="portlet box yellow">
        <div class="portlet-title">
			...
			<?php echo $this->Metronic->getLinkButton(
                __('Export CSV de toutes les communications par tranche'),
                array('controller' => 'accounts', 'action' => 'export_com_tranche', 'admin' => true),
                'btn blue pull-right',
                'icon-file'
            ); ?>
            <?php echo $this->Metronic->getLinkButton(
            ...
            <?php else: ?>
                <table class="table table-striped table-hover table-bordered">
                    ...
                    <tr>
                        ...
                        <th><?php echo $this->Paginator->sort('UserCreditHistory.user_credits_before', __('Crédits avant')); ?></th>
                    ...
                    <?php foreach ($lastCom as $k => $row): ?>
                        <tr>
                            ...
                            <td><?php echo $this->Metronic->getLinkButton(
                                    __('Voir l\'historique complet du client')   ,
                                    array('controller' => 'accounts', 'action' => 'com_view', 'admin' => true, 'id' => $row['UserCreditHistory']['user_id']),
                                    'btn blue',
                                    'icon-zoom-in'
                                ); ?>
                            </td>
