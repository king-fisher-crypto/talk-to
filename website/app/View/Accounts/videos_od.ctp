...
<section class="videos_od-page page jswidth">


    <article class="marge">
	<h1 class="">  <?= __('Mes vidéos à la demande') ?></h1>
	<?= __("Vos achats de Vidéos à la demande sont répertoriés sur la page ci-dessous, en cliquant sur le bouton \" Voir \" vous accédez à la page répertoriant l'ensemble de vos Vidéos à la demande achetées.") ?>
	...
	<?php else : ?>
    	<div  class="overflow jswidth">
			...
			<th class="agent"><?php echo __('Agent'); ?></th> 
    			<th class="duree"><?= __('Vidéo à la')."<br/>".__('demande'); ?></th> 
...
<td class="montant "><?=$masterclass['montant']; ?></td> 
