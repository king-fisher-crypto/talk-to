...
<section class="photos_od-page page jswidth">


    <article class="marge">
	<h1 class="">  <?= __('Mes Photos à la demande') ?></h1>
	<?= __("Vos achats de Photos à la demande sont répertoriés sur la page ci-dessous, en cliquant sur le bouton \" Voir \" vous accédez à la page répertoriant l'ensemble de vos Photos à la demande achetées.") ?>
	...
	$masterclass['montant'] = "Via Requête Paiement";
	...
	<?php else : ?>
    	<div  class="overflow jswidth">
			...
			<th class="agent"><?php echo __('Agent'); ?></th> 
    			<th class="duree"><?= __('Photo à la')."<br/>".__('demande'); ?></th> 
...
<td class="montant "><?php echo $masterclass['montant']; ?></td> 
