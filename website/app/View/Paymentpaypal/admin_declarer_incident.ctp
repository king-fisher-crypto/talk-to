<?php
echo $this->Metronic->titlePage(__('Statement against Paypal'));
echo $this->Metronic->breadCrumb(array(
    0 => array(
        'text' => __('Accueil'), 'classes' => 'icon-home', 'link' => $this->Html->url(array('controller' => 'admins', 'action' => 'index', 'admin' => true))
    ),
    1 => array(
        'text' => __('Incident Paypal'), 'classes' => 'icon-euro'
    )
));
...
<div class="row-fluid">
    <div class="portlet box yellow">
        <div class="portlet-title">
            <div class="caption">Paypal declaration</div>
        ...
        <div class="portlet-body">
			<div class="row-fluid">
				<div class="span4">
					<fieldset>
						<legend>Paypal Transaction </legend>
						...
						<p><strong>Payer ID :</strong> <?php echo $order['paypal_logs']['payerid']; ?></p>
						 <p><strong>Transaction ID :</strong> <?php echo $order['paypal_logs']['payment_transactionid']; ?></p>
						<p><strong>Token :</strong> <?php echo $order['paypal_logs']['token']; ?></p>
					</fieldset>
				</div>
				<div class="span4">
					<fieldset>
						<legend>Transaction Spiriteo</legend>
						<p style="font-size:14px"><strong>Email account paypal : </strong> <input value="<?php echo $order['paypal_logs']['email']; ?>" style="border:0;font-size:16px" id="PaypalEmailOpposition" rel="<?php echo $order['paypal_logs']['order_id']; ?>" \></p>
						...
						<p><strong>Client email spiriteo : </strong> <?php echo str_replace('delete_','',$order['User']['email']); ?></p>
