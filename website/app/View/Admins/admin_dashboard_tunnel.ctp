		...
		<div class="portlet box purple" >
			...
			<div class="portlet-body">
				<ul class="nav nav-tabs">
				  <li class="active"><a style="padding-right: 5px;padding-left: 5px;" href="#tab_canvas_carts_today" data-toggle="tab">Aujourd'hui</a></li>
				...
				<div class="tab-content">
					<div class="tab-pane fade in active" id="tab_canvas_carts_today"><canvas id="canvas_carts_today"></canvas></div>
