	...
	<div class="span6 responsive">
   	...
   	<div class="span6 responsive">
		<div class="portlet box red" >
			...
			<div class="portlet-body">
				<ul class="nav nav-tabs">
				  <li class="active"><a style="padding-right: 5px;padding-left: 5px;" href="#tab_canvas_consult_source_today" data-toggle="tab">Aujourd'hui</a></li>
				...
				<div class="tab-content">
					<div class="tab-pane fade in active" id="tab_canvas_consult_source_today"><canvas id="canvas_consult_source_today"></canvas></div>
...
<div class="row-fluid">
  <div class="span6 responsive">
		<div class="portlet box red" >
			...
			<div class="portlet-body">
				<ul class="nav nav-tabs">
				  <li class="active"><a style="padding-right: 5px;padding-left: 5px;" href="#tab_canvas_consult_country_today" data-toggle="tab">Aujourd'hui</a></li>
				...
				<div class="tab-content">
					<div class="tab-pane fade in active" id="tab_canvas_consult_country_today"><canvas id="canvas_consult_country_today"></canvas></div>
	 ...
	 <div class="span6 responsive">
		<div class="portlet box purple" >
			...
			<div class="portlet-body">
				<ul class="nav nav-tabs">
				  <li class="active"><a style="padding-right: 5px;padding-left: 5px;" href="#tab_canvas_consult_nb_today" data-toggle="tab">Aujourd'hui</a></li>
				  ...
				  <li><a style="padding-right: 5px;padding-left: 5px;" href="#tab_canvas_consult_nb_prev2_month" data-toggle="tab">Mois -2</a></li>
				...
				<div class="tab-content">
					<div class="tab-pane fade in active" id="tab_canvas_consult_nb_today"><canvas id="canvas_consult_nb_today"></canvas></div>
...
<div class="row-fluid">
   	<div class="span6 responsive">
		<div class="portlet box red" >
			...
			<div class="portlet-body">
				<ul class="nav nav-tabs">
				  <li class="active"><a style="padding-right: 5px;padding-left: 5px;" href="#tab_canvas_consult_country_nb_today" data-toggle="tab">Aujourd'hui</a></li>
				...
				<div class="tab-content">
					<div class="tab-pane fade in active" id="tab_canvas_consult_country_nb_today"><canvas id="canvas_consult_country_nb_today"></canvas></div>
	 ...
	 <div class="span6 responsive">
		<div class="portlet box purple" >
			...
			<div class="portlet-body">
				<ul class="nav nav-tabs">
				  <li class="active"><a style="padding-right: 5px;padding-left: 5px;" href="#tab_canvas_consult_type_nb_today" data-toggle="tab">Aujourd'hui</a></li>
				...
				<div class="tab-content">
					<div class="tab-pane fade in active" id="tab_canvas_consult_type_nb_today"><canvas id="canvas_consult_type_nb_today"></canvas></div>
...
<div class="row-fluid">
   	<div class="span6 responsive">
		<div class="portlet box red" >
			<div class="portlet-title">
				<div class="caption"><?php echo __('Consultations audiotel par Pays'); ?></div>
			</div>
			<div class="portlet-body">
				<ul class="nav nav-tabs">
				  <li class="active"><a style="padding-right: 5px;padding-left: 5px;" href="#tab_canvas_consult_audiotel_domain_today" data-toggle="tab">Aujourd'hui</a></li>
				  <li><a style="padding-right: 5px;padding-left: 5px;" href="#tab_canvas_consult_audiotel_domain_yesterday" data-toggle="tab">Hier</a></li>
				  <li><a style="padding-right: 5px;padding-left: 5px;" href="#tab_canvas_consult_audiotel_domain_prev_day" data-toggle="tab">J-2</a></li>
				  <li><a style="padding-right: 5px;padding-left: 5px;" href="#tab_canvas_consult_audiotel_domain_prev_week" data-toggle="tab">J-7</a></li>
				  <li><a style="padding-right: 5px;padding-left: 5px;" href="#tab_canvas_consult_audiotel_domain_month" data-toggle="tab">Mois</a></li>
				  <li><a style="padding-right: 5px;padding-left: 5px;" href="#tab_canvas_consult_audiotel_domain_prev_month" data-toggle="tab">Mois dernier</a></li>
				  <li><a style="padding-right: 5px;padding-left: 5px;" href="#tab_canvas_consult_audiotel_domain_prev2_month" data-toggle="tab">Mois -2</a></li>
				  <li><a style="padding-right: 5px;padding-left: 5px;" href="#tab_canvas_consult_audiotel_domain_prev_year" data-toggle="tab">J N-1</a></li>
				  <li><a style="padding-right: 5px;padding-left: 5px;" href="#tab_canvas_consult_audiotel_domain_prev_month_year" data-toggle="tab">M N-1</a></li>
				</ul>
				<div class="tab-content">
					<div class="tab-pane fade in active" id="tab_canvas_consult_audiotel_domain_today"><canvas id="canvas_consult_audiotel_domain_today"></canvas></div>
					<div class="tab-pane fade" id="tab_canvas_consult_audiotel_domain_yesterday"><canvas id="canvas_consult_audiotel_domain_yesterday"></canvas></div>
					<div class="tab-pane fade" id="tab_canvas_consult_audiotel_domain_prev_day"><canvas id="canvas_consult_audiotel_domain_prev_day"></canvas></div>
					<div class="tab-pane fade" id="tab_canvas_consult_audiotel_domain_prev_week"><canvas id="canvas_consult_audiotel_domain_prev_week"></canvas></div>
					<div class="tab-pane fade" id="tab_canvas_consult_audiotel_domain_prev_year"><canvas id="canvas_consult_audiotel_domain_prev_year"></canvas></div>
					<div class="tab-pane fade" id="tab_canvas_consult_audiotel_domain_month"><canvas id="canvas_consult_audiotel_domain_month"></canvas></div>
					<div class="tab-pane fade" id="tab_canvas_consult_audiotel_domain_prev_month"><canvas id="canvas_consult_audiotel_domain_prev_month"></canvas></div>
					<div class="tab-pane fade" id="tab_canvas_consult_audiotel_domain_prev2_month"><canvas id="canvas_consult_audiotel_domain_prev2_month"></canvas></div>
					<div class="tab-pane fade" id="tab_canvas_consult_audiotel_domain_prev_month_year"><canvas id="canvas_consult_audiotel_domain_prev_month_year"></canvas></div>
				</div>
			</div>
		</div>
	</div>
	<div class="span6 responsive">
		<div class="portlet box red" >
			<div class="portlet-title">
				<div class="caption"><?php echo __('Consultations anciens VS nouveaux'); ?></div>
			</div>
			<div class="portlet-body">
				<ul class="nav nav-tabs">
				  <li class="active"><a style="padding-right: 5px;padding-left: 5px;" href="#tab_canvas_consult_new_today" data-toggle="tab">Aujourd'hui</a></li>
				  <li><a style="padding-right: 5px;padding-left: 5px;" href="#tab_canvas_consult_new_yesterday" data-toggle="tab">Hier</a></li>
				  <li><a style="padding-right: 5px;padding-left: 5px;" href="#tab_canvas_consult_new_prev_day" data-toggle="tab">J-2</a></li>
				  <li><a style="padding-right: 5px;padding-left: 5px;" href="#tab_canvas_consult_new_prev_week" data-toggle="tab">J-7</a></li>
				  <li><a style="padding-right: 5px;padding-left: 5px;" href="#tab_canvas_consult_new_month" data-toggle="tab">Mois</a></li>
				  <li><a style="padding-right: 5px;padding-left: 5px;" href="#tab_canvas_consult_new_prev_month" data-toggle="tab">Mois dernier</a></li>
				  <li><a style="padding-right: 5px;padding-left: 5px;" href="#tab_canvas_consult_new_prev2_month" data-toggle="tab">Mois -2</a></li>
				  <li><a style="padding-right: 5px;padding-left: 5px;" href="#tab_canvas_consult_new_prev_year" data-toggle="tab">J N-1</a></li>
				  <li><a style="padding-right: 5px;padding-left: 5px;" href="#tab_canvas_consult_new_prev_month_year" data-toggle="tab">M N-1</a></li>
				</ul>
				<div class="tab-content">
					<div class="tab-pane fade in active" id="tab_canvas_consult_new_today"><canvas id="canvas_consult_new_today"></canvas></div>
					<div class="tab-pane fade" id="tab_canvas_consult_new_yesterday"><canvas id="canvas_consult_new_yesterday"></canvas></div>
					<div class="tab-pane fade" id="tab_canvas_consult_new_prev_day"><canvas id="canvas_consult_new_prev_day"></canvas></div>
					<div class="tab-pane fade" id="tab_canvas_consult_new_prev_week"><canvas id="canvas_consult_new_prev_week"></canvas></div>
					<div class="tab-pane fade" id="tab_canvas_consult_new_prev_year"><canvas id="canvas_consult_new_prev_year"></canvas></div>
					<div class="tab-pane fade" id="tab_canvas_consult_new_month"><canvas id="canvas_consult_new_month"></canvas></div>
					<div class="tab-pane fade" id="tab_canvas_consult_new_prev_month"><canvas id="canvas_consult_new_prev_month"></canvas></div>
					<div class="tab-pane fade" id="tab_canvas_consult_new_prev2_month"><canvas id="canvas_consult_new_prev2_month"></canvas></div>
					<div class="tab-pane fade" id="tab_canvas_consult_new_prev_month_year"><canvas id="canvas_consult_new_prev_month_year"></canvas></div>
				</div>
			</div>
		</div>
	</div>
