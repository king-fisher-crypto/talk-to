...
<div class="row-fluid">
    <?php echo $this->Form->create('Slide', array('nobootstrap' => 1,'class' => 'form', 'default' => 1, 'enctype' => 'multipart/form-data',
                                                 'inputDefaults' => array(
                                                     'div' => 'control-group',
    ...
    <div class="row-fluid">
                ...
                <div class="tab-content">
                    <?php $i=0; foreach($langs as $id => $val): ?>
                        <div id="tab<?php echo $id; ?>" class="tab-pane<?php echo ($i==0 ?' active':''); ?>">
                            <?php echo $this->Metronic->formSlideLang($slideDatas['id'],$id,(isset($langDatas[$id])?$langDatas[$id]:array())); ?>
                        </div>
                        <?php $i = 1; ?>
                    <?php endforeach; ?>
                </div>
        ...
        <div class="span8 block_edit_admin panel-contenu">
            <div class="row-fluid">
                <div class="span4">
                    <?php
                        echo $this->Metronic->inputActive('Slide', 1);
    ...
    <div class="row-fluid">
        <div class="span12 block_duplicate_admin panel-contenu">
            <?php
            echo $this->Metronic->formDuplicateLangs('Slide', $this->Session->read('Config.id_lang'));
            ?>
        </div>
    </div>
</div>
