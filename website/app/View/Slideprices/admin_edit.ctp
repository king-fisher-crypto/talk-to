...
<div class="row-fluid">
    <?php echo $this->Form->create('Slideprice', array('nobootstrap' => 1,'class' => 'form', 'default' => 1, 'enctype' => 'multipart/form-data',
                                                 'inputDefaults' => array(
                                                     'div' => 'control-group',
                ...
                <div class="tab-content">
                    <?php $i=0; foreach($langs as $id => $val): ?>
                        <div id="tab<?php echo $id; ?>" class="tab-pane<?php echo ($i==0 ?' active':''); ?>">
                            <?php echo $this->Metronic->formSlidepriceLang($slideDatas['id'],$id,(isset($langDatas[$id])?$langDatas[$id]:array())); ?>
                        </div>
                        <?php $i = 1; ?>
                    <?php endforeach; ?>
                </div>
    ...
    <div class="row-fluid">
        <div class="span12 block_duplicate_admin panel-contenu">
            <?php
            echo $this->Metronic->formDuplicateLangs('Slideprice', $this->Session->read('Config.id_lang'));
            ?>
        </div>
    </div>
</div>
