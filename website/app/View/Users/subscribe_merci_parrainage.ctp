...
<div class="container">
	<section class="single-page form-page ">
		<div class="content_box mt20 mb40 wow fadeIn subscribemerciparrainage" data-wow-delay="0.4s">
			<?php echo $this->Session->flash(); ?>
			<?php 
			
			$content = $this->FrontBlock->getPageBlocTexte(352);
			$page_content = str_replace('##FIRSTNAME##',$firstname,$content);
