                            ...
                            <td>
                                <?php
									if((!empty($user_level) && $user_level != 'moderator') || $review['Review']['rate'] == 5) {
                                        ...
                                        if ($review['Review']['rate'] == 5 && $review['Review']['status'] == -1) {
                                            echo $this->Metronic->getLinkButton(
                                                __('Basculer vers avis négatifs'),
                                                array('controller' => 'reviews', 'action' => 'moveneg_review', 'admin' => true, 'id' => $review['Review']['review_id']),
                                                'btn purple',
                                                'icon-remove',
                                                __('Voulez-vous vraiment basculer l\'avis vers les avis négatifs ?')
                                            );
                                            echo ' ';
                                        }
									}
