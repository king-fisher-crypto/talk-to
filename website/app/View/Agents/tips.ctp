...
<section class="subscription-page a-tips-page page jswidth">


    <article>
	<h1 class="">  <?= __('Mes Pourboires') ?></h1>
	...
	<?php else : ?>
    	<div  class="overflow jswidth">
    		...
    		<thead class=""> 
    			...
    			<th class="date"><?php echo __('Date versement'); ?></th> 
...
<?php endforeach; ?>
	...
	<div class="div_total"> <span>total</span> <span>2 545,00 $</span></div>
