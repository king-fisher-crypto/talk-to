...
<section class="subscription-page a-historylostemail-page page jswidth">


    <article>
	<h1 class="">  <?= __('Mes Emails perdus') ?></h1>
		<?= __("Par mesure de sécurité, le mode Email est automatiquement désactivé si vous ne répondez pas dans les délais prévus, il vous appartient ensuite de réactiver ce mode. Nous attirons votre attention sur la nécessité de répondre dans les délais et à l'image que vous donnez en ne répondant pas, pouvant créer un désengagement de vos clients.") ?>	
    </article>
	...
	$statuts = ["oui","oui","oui","oui","oui","oui","oui","oui","oui","oui","oui"];
	
	$fin = ["","","Mettre fin","","Mettre fin","","","","","",""];
	
	$statuts_color = ["orange2","orange2","orange2","orange2","orange2","orange2","orange2","orange2","orange2","orange2","orange2"];
	...
	<?php else : ?>
    	<div  class="overflow jswidth">
			...
			<th class="desactivation"><div style="display:inline-block;text-align:left;"><?php echo __('Email remboursé<br/>dépassement délai '); ?></div></th> 
