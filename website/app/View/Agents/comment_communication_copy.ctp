<section class="slider-small">
				...
				<div class="col-sm-12 col-md-9">
					<div class="content_box mobile-center wow mb0 fadeIn" data-wow-delay="0.4s">
						...
						<div class="page-header">
							<h2 class="uppercase wow fadeIn" data-wow-delay="0.3s"> <?php echo __('Téléphone, Mail et Tchat') ?></h2>
							 <?php
						...
						echo $this->element('title', array(
							'breadcrumb' => array(
								...
								1   =>  array(
									'name'  =>  __('Téléphone, Mail et Tchat'),
									'link'  =>  ''
								)
							)
						));
 ...
 <?php 
			...
			$idlang = $this->Session->read('Config.id_lang');
						echo $this->FrontBlock->getPageBlocTextebyLang(313,$idlang);
						?>
