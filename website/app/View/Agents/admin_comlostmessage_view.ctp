<?php
    ...
    echo $this->Metronic->breadCrumb(array(
        ...
        4 => array(
            'text' => __('Historique des emails perdus'),
...
<div class="row-fluid">
    ...
    <div class="portlet box yellow">
        <div class="portlet-title">
            <div class="caption"><?php echo __('Tous les emails perdus de').' '.$this->Html->link($user['User']['pseudo'],array('controller' => 'agents', 'action' => 'view', 'admin' => true, 'id' => $user['User']['id'], 'full_base' => true)); ?></div>
        ...
        <div class="portlet-body">
            ...
            <?php else: ?>
                <table class="table table-striped table-hover table-bordered">
                    <thead>
                    <tr>
						<th><?php echo $this->Paginator->sort('Message.id', __('ID')); ?></th>
                        <th><?php echo $this->Paginator->sort('User.firstname', __('Client')); ?></th>
                        <th><?php echo $this->Paginator->sort('Message.date_add', __('Date consultation')); ?></th>
						 <th><?php echo $this->Paginator->sort('UserPenality.delay', __('Délai')); ?></th>
                    </tr>
                    </thead>
                    <tbody>
                    <?php 
