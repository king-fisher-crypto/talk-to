            ...
            <ul class="list-unstyled ml0">
                <?php
                    foreach($messages as $message) :
						if(empty($message['User']['firstname']) || $message['User']['firstname'] === $this->Session->read('Auth.User.firstname')) echo '<li class="me">'; else echo '<li class="he">';
						...
						echo ' - ';
						if(empty($message['User']['firstname'])|| $message['User']['firstname'] === $this->Session->read('Auth.User.firstname')) echo '<span class="who">Moi</span>'; else echo '<span class="who">'.$message['User']['firstname'].'</span>';
...
<section class="slider-small">
		<h1 class="wow fadeInDown" data-wow-delay="0.5s"><?php echo __('Mes chats') ?></h1>
					...
					<div class="table-responsive">
				  	 <table class="table table-striped no-border table-mobile text-center mb0"> 
                        ...
                        <?php foreach($chats as $chat) :
						 ...
						 ?>
                                <tr>
                                    <td> <?php echo $chat['User']['firstname']; ?></td>
