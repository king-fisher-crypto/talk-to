...
<section class="subscription-page a-historylostwebcam-page page jswidth">


    <article>
	<h1 class="">  <?= __('Mes Webcam perdues') ?></h1>
		<?= __("Par mesure de sécurité, le mode Webcam est automatiquement désactivé après 3 appels Webcam perdus, il vous appartient ensuite de réactiver ce mode. Nous attirons votre attention sur la nécessité de répondre à vos appels Webcam et à l'image que vous donnez en ne répondant pas, pouvant créer un désengagement de vos clients.") ?>	
    </article>
	...
	<?php else : ?>
    	<div  class="overflow jswidth">
			...
			<th class="desactivation"><div style="display:inline-block;text-align:left;"><?php echo __('Désactivation<br/>mode Webcam'); ?></div></th> 
    		    </tr> 
    		</thead> 
    		<tbody>
