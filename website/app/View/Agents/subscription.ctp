...
<section class="subscription-page page jswidth">
	...
	<?php else : ?>
    	<div  class="overflow jswidth">
			...
			<th class="date " style="text-align: center;" ><div style="text-align: left;display: inline-block;"><?php echo __('Nombre')."<br/>".__('mois'); ?></div></th> 
...
<?php endforeach; ?>
	...
	<div class="div_total"> <span>total</span> <span>625 545,56 $</span></div>
