...
//load data facture
$result_invoice = $mysqli->query("SELECT I.* FROM  invoice_agents I, users U WHERE I.user_id = U.id and I.date_add >= '{$sql_date_min}' and I.date_add <= '{$sql_date_max}' and I.status >= 0 ");
