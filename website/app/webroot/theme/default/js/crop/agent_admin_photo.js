var nx_agent_photo = {
        ...
        fileInput.addEventListener('change', function(e) {
            ...
            if(allowedTypes.indexOf(filetype) != -1){
                ...
                reader.onload = function(e) {
                    $("#myModal").remove();
                    nxAdminMain.ajaxRequest('/users/modalPhotoAgent',{image: reader.result},function(html){
                        $("body").append(html);
                        $("#myModal").modal({
                            backdrop: 'static',
                            keyboard: false,
    ...
    saveCoordCrop : function(c){
        ...
        $('#UserCropX')[0].value = c.x;
        $('#UserCropY')[0].value = c.y;
        $('#UserCropW')[0].value = c.w;
        $('#UserCropH')[0].value = c.h;
    },
