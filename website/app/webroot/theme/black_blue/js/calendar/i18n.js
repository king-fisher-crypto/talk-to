...
export const i18n = {
     ...
     * Turkish
     */
    tr: new Locale('Ocak_?ubat_Mart_Nisan_May?s_Haziran_Temmuz_A?ustos_Eylül_Ekim_Kas?m_Aral?k'.split('_'), null, 
        'Pazar_Pazartesi_Sal?_Çar?amba_Per?embe_Cuma_Cumartesi'.split('_'), 
    ...
    vi: new Locale('tháng 1_tháng 2_tháng 3_tháng 4_tháng 5_tháng 6_tháng 7_tháng 8_tháng 9_tháng 10_tháng 11_tháng 12'.split('_'), 
        ...
        'ch? nh?t_th? hai_th? ba_th? t?_th? n?m_th? sáu_th? b?y'.split('_'), 
