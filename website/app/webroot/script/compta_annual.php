...
var_dump("SELECT U.type_pay,U.ca as ca_devise,U.ca_currency, P.ca, P.price, U.ca_ids, U.credits from  user_credit_history U, user_pay P WHERE U.date_start >= '".$date_debut."' and U.date_start <= '".$date_fin."' and U.is_factured = 1 and U.type_pay = 'pre' and P.id_user_credit_history = U.user_credit_history order by U.user_credit_history");
...
$resultcomm = $mysqli->query("SELECT U.type_pay,U.ca as ca_devise,U.ca_currency, P.ca, P.price, U.ca_ids, U.agent_id from  user_credit_history U, user_pay P WHERE U.date_start >= '".$date_debut ."' and U.date_start <= '".$date_fin."' and P.id_user_credit_history = U.user_credit_history and U.type_pay = 'pre' order by U.user_credit_history");
while($rowcomm = $resultcomm->fetch_array(MYSQLI_ASSOC)){
	if($rowcomm['ca_currency'] == 'CHF' )
...
$resultcomm = $mysqli->query("SELECT U.type_pay,U.ca as ca_devise,U.ca_currency, P.ca, P.price, U.ca_ids, U.agent_id from  user_credit_history U, user_pay P WHERE U.date_start >= '".$date_debut ."' and U.date_start <= '".$date_fin."' and U.is_factured = 0 and P.id_user_credit_history = U.user_credit_history order by U.user_credit_history");
	while($rowcomm = $resultcomm->fetch_array(MYSQLI_ASSOC)){
...
$resultcomm = $mysqli->query("SELECT U.type_pay,U.ca as ca_devise,U.ca_currency, P.ca, P.price, U.ca_ids, U.agent_id from  user_credit_history U, user_pay P WHERE U.date_start >= '".$date_debut ."' and U.date_start <= '".$date_fin."' and U.is_factured = 1 and P.id_user_credit_history = U.user_credit_history order by U.user_credit_history");
	while($rowcomm = $resultcomm->fetch_array(MYSQLI_ASSOC)){
		...
		//check if facture
		$resultfact = $mysqli->query("SELECT * from  invoice_agents WHERE date_add >= '".$fact_date_debut."' and date_add <= '".$fact_date_fin."' and user_id = '".$rowcomm['agent_id']."' and status < 10");
...
$resultfact = $mysqli->query("SELECT * from  invoice_agents WHERE date_add >= '".$fact_date_debut."' and date_add <= '".$fact_date_fin."' and date_min < '".$date_debut."' and status < 10 order by id");
while($rowfact = $resultfact->fetch_array(MYSQLI_ASSOC)){
	
	$resultcomm = $mysqli->query("SELECT U.type_pay,U.ca as ca_devise,U.ca_currency, P.ca, P.price, U.ca_ids from  user_credit_history U, user_pay P WHERE U.date_start >= '".$rowfact['date_min']."' and U.date_start < '".$date_debut."' and U.is_factured = 1 and U.agent_id = '".$rowfact['user_id']."' and P.id_user_credit_history = U.user_credit_history order by U.user_credit_history");
	while($rowcomm = $resultcomm->fetch_array(MYSQLI_ASSOC)){
...
$ca_genere_facture = 0;
$resultfact = $mysqli->query("SELECT * from  invoice_agents WHERE date_add >= '".$fact_date_debut."' and date_add <= '".$fact_date_fin."' and status < 10  order by id");
while($rowfact = $resultfact->fetch_array(MYSQLI_ASSOC)){
...
$resultfact = $mysqli->query("SELECT * from  invoice_agents WHERE date_add >= '".$fact_date_debut."' and date_add <= '".$fact_date_fin."' and status >= 0 and status < 10 order by id");
while($rowfact = $resultfact->fetch_array(MYSQLI_ASSOC)){
