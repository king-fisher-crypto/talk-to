...
$date_debut = '2020-11-30 23:00:00';
$date_fin = '2020-12-31 22:59:59';
...
$resultcomm = $mysqli->query("SELECT U.type_pay,U.ca as ca_devise,U.ca_currency, P.ca, P.price, U.ca_ids from  user_credit_history U, user_pay P WHERE U.date_start >= '".$date_debut ."' and U.date_start <= '".$date_fin."' and U.is_factured = 1 and P.id_user_credit_history = U.user_credit_history order by U.user_credit_history");
