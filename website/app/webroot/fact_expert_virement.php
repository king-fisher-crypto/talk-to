...
//get order society
	...
	$date = date('Y-m-d 00:00:00', strtotime('-5 month'));
...
//load data facture
$result_invoice = $mysqli->query("SELECT I.* FROM  invoice_agents I, users U WHERE U.stripe_account = '' and I.user_id = U.id and I.date_min >= '{$session_date_min}' and I.date_max <= '{$session_date_max}' and I.status =1");
$page = 0;
...
$filename_period_an = $date_filename->format('Y');
	...
	$filename = 'Facture frais de service Glassgen Virement'.$filename_period_month. ' '.$filename_period_an.'.pdf';
