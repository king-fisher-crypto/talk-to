 ...
 */
	function __($singular, $args = null, $uppercase=true) {
		if (!$singular) {
			return null;
		}
		...
		$translated2 =  I18n::insertArgs($translated, array_slice($arguments, 1));
		
		if($uppercase) {
		   // $translated2 = mb_convert_case($translated2, MB_CASE_TITLE, 'UTF-8');
		    $translated2  = ucfirst($translated2);
		}
		return $translated2;
	}
